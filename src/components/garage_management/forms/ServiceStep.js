                          ...
                          <Col md="4 mb-3" key={makeIndex}>
                            <Label className="d-block" for={`category-${index}-make-${makeIndex}`} >
                              <Input
                                ...
                                checked={el.automobile_makes[makeIndex].checked}
                                type="checkbox"
                                ...
                                make.models.map((model, modelIndex) => {
                                  return (<Col md="12" key={modelIndex}> <Label className="d-block" for="chk-ani">
                                    <Input
                                      ...
                                      type="checkbox" name={`category-${index}-make-${makeIndex}-model-${modelIndex}`}
...
<Card>
        <CardBody>
                  <div className="form-row mb-2" >
                    {el.services.map((make, serviceIndex) => {
                      return (
                          ...
                          <Col md="4 mb-3" >
                            <Label className="d-block" for={`category-${index}-service-${serviceIndex}`} >
                              <Input
                                ...
                                checked={el.services[serviceIndex].checked}
                                type="checkbox"
