                                ...
                                <Collapse isOpen={isDevelopment}>
                                    <div className="collapse show" id="collapseicon2" aria-labelledby="collapseicon2" data-parent="#accordion">
                                        <CardBody className="upcoming-course">
                                            <Media>
                                                <Media body><span className="f-w-600">{UXDevelopment}</span><span className="d-block">{CourseBy} <a href="#javascript"> {LorumIpsum}</a></span><span className="d-block"><i className="fa fa-star font-warning"></i><i className="fa fa-star font-warning"></i><i className="fa fa-star font-warning"></i><i className="fa fa-star font-warning"></i><i className="fa fa-star-half-o font-warning"></i></span></Media>
                                                <div>
                                                    <h5 className="mb-0 font-primary">{"18"}</h5><span className="d-block">{"Dec"}</span>
                                                </div>
                                            </Media>
                                            <Media>
                                                <Media body><span className="f-w-600">{BusinessAnalyst}</span><span className="d-block">{CourseBy} <a href="#javascript">{LorumIpsum} </a></span><span className="d-block"><i className="fa fa-star font-warning"></i><i className="fa fa-star font-warning"></i><i className="fa fa-star font-warning"></i><i className="fa fa-star font-warning"></i><i className="fa fa-star font-warning"></i></span></Media>
                                                <div>
                                                    <h5 className="mb-0 font-primary">{"28"}</h5><span className="d-block">{"Dec"}</span>
                                                </div>
                                            </Media>
                                            <Media>
                                                <Media body><span className="f-w-600">{WebDevelopment}</span><span className="d-block">{CourseBy} <a href="#javascript">{LorumIpsum} </a></span><span className="d-block"><i className="fa fa-star font-warning"></i><i className="fa fa-star font-warning"></i><i className="fa fa-star font-warning"></i><i className="fa fa-star font-warning"></i><i className="fa fa-star-o font-warning"></i></span></Media>
                                                <div>
