...
import {Email,MarekjecnoMailId,BOD,DDMMYY,Designer,ContactUs,ContactUsNumber,LocationDetails,JOHANDIO,Comment,MarkJecno,Like,Follower,Following,Location} from '../../constant'
const UserProfile = (props) => {
    return (
        <Fragment>
        <BreadCrumb parent="Home" subparent="Users" title="User Profile"/>
                  ...
                  <Col sm="12">
                    <Card className="card hovercard text-center">
                      ...
                      <div className="user-image">
                        ...
                        <div className="icon-wrapper" data-intro="Change Profile image here"><i className="icofont icofont-pencil-alt-5"></i></div>
                      </div>
                      <div className="info">
                        <Row>
