...
const Modals = (props) => {
    ...
    return (
      <Fragment>
        <BreadCrumb parent="Home" subparent="Base" title="Modal"/>
              ...
              <CardBody className="card-body btn-showcase">
                 <Button color="primary" onClick={toggle}>{Simple}</Button>
                    <Modal isOpen={modal} toggle={toggle} >
                        <ModalHeader toggle={toggle}>{ModalTitle}
                        </ModalHeader>
                        <ModalBody>
                        ....
                        </ModalBody>
                ...
                <Modal isOpen={tooltippopover} toggle={Tooltippopovermodaltoggle} centered>
                    <ModalHeader toggle={Tooltippopovermodaltoggle}>
                      ...
                      <ModalBody>
                        ...
                        <p>{"This"} <a className="btn btn-primary popover-test" href="#javascript" >{"button"}</a> {"triggers a popover on click."}</p>
                        <hr/>
          ...
          <Col sm="12">
            <Card>
              ...
              <CardBody className="card-body btn-showcase">
                ...
                <Button color="primary" onClick={SmallModaltoggle}>{SmallModal}</Button>
