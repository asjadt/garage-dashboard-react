...
import { Airplay, BarChart, Box, CloudLightning, CreditCard, FileText, FolderPlus, GitPullRequest, Home, Layout, Map, Server, Sidebar, Sliders } from 'react-feather';
import { Button, Card, CardBody, CardHeader, Col, Container, Row } from 'reactstrap';
import { ActiveAndDisabledLinks, Advance, Base, Cards, Charts, Dashboard, DefaultNav, DropdownExample, Editors, Footers, Forms, General, InlineNav, ItemBullets, Layouts, LogOuts, Maps, PageLayout, Rating, Scrollable, SectionAndSeparator, Sidebars, StaticSubNav, SubNav, Tables, Timeline, ToggleSubNav, TreeView, Widgets } from '../../../constant';
...
const Navs = (props) => {
  return (
    <Fragment>
      <BreadCrumb parent="Home" subparent="Base" title="Navs" />
            ...
            <Card className="card height-equal">
              ...
              <CardBody>
                <ul className="icon-lists border navs-icon">
                  ...
                  <li className="pt-0">
                    <Button color="outline-primary" className="btn btn-pill">{LogOuts}</Button>
                  </li>
                </ul>
                <div className="onhover-dropdown navs-dropdown">
                  <Button color="primary" className="onhover-dropdown">{DropdownExample} <i className="icon-arrow-down"></i></Button>
