...
import {DefaultList,LinksAndButtons,FlushStyle,ContextualClasses,WithBadges,WithIcon,WithImages,WithImageRounded,JavaScriptBehavior,CustomContent,Homes,Profile,Messages,Settings} from '../../constant'
...
const  List = (props) => {
    ...
    return (
      <Fragment>
        <BreadCrumb parent="Home" subparent="Base" title="Lists"/>
            ...
            <Row>
              ...
              <Col sm="12" xl="12">
                <Card>
                  ...
                  <CardBody>
                    <ListGroup>
                        <ListGroupItem>{"Dapibus ac facilisis in"}</ListGroupItem>
                        <ListGroupItem className="list-group-item-primary">{"This is a primary list group item"}</ListGroupItem>
                        <ListGroupItem className="list-group-item-secondary">{"This is a secondary list group item"}</ListGroupItem>
                        <ListGroupItem className="list-group-item-success">{"This is a success list group item"}</ListGroupItem>
                        <ListGroupItem className="list-group-item-danger">{"This is a danger list group item"}</ListGroupItem>
                        <ListGroupItem className="list-group-item-warning">{"This is a warning list group item"}</ListGroupItem>
                        <ListGroupItem className="list-group-item-info">{"This is a info list group item"}</ListGroupItem>
                        <ListGroupItem className="list-group-item-light">{"This is a light list group item"}</ListGroupItem>
                        <ListGroupItem className="list-group-item-dark">{"This is a dark list group item"}</ListGroupItem>
                    </ListGroup>
                  </CardBody>
                </Card>
              </Col>
              ...
              <Col sm="12" xl="12">
                <Card>
                  ...
                  <CardBody>
                    <Row>
                      <Col sm="4" className="tab-javascript">
                            <ListGroup className="nav-primary nav-pills">
                              <ListGroupItem  href="#javascript"  className={activeTab === '1' ? 'list-group-item-action active' : ''} onClick={() => setActiveTab('1')}>{Homes}</ListGroupItem>
                            </ListGroup>
                            <ListGroup>
                      ...
                      <Col sm="8">
                        <TabContent activeTab={activeTab}>
                          <TabPane tabId="1" className="fade show">{"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum."}</TabPane>
                          <TabPane tabId="2" className="fade show">{"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum."}</TabPane>
                          <TabPane tabId="3" className="fade show">{"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum."}</TabPane>
                          <TabPane tabId="4" className="fade show">{"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum."}</TabPane>
                        </TabContent>
                      </Col>
                    </Row>
                  </CardBody>
                ...
                <Card>
                  ...
                  <CardBody>
                    <ListGroup>
                        ...
                        <Media body src={require("../../assets/images/user/1.jpg")} alt=""/>{"Cras justo odio"}
                        </ListGroupItem>
                        <ListGroupItem className="list-group-item-action" tag="a" href="#javascript">
                        <Media body src={require("../../assets/images/user/1.jpg")} alt=""/>{"Dapibus ac facilisis in"}
                         </ListGroupItem>
                        <ListGroupItem className="list-group-item-action" tag="a" href="#javascript">
                        <Media body src={require("../../assets/images/user/1.jpg")} alt=""/>{"Morbi leo risus"}</ListGroupItem>
                        <ListGroupItem className="list-group-item-action disabled"><Media body src={require("../../assets/images/user/1.jpg")} alt=""/>{"Vestibulum at eros"}
                       </ListGroupItem>
                    </ListGroup>
                  </CardBody>
                </Card>
