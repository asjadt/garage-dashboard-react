...
const Avatars = (props) => {
    return (
      <Fragment>
        <BreadCrumb parent="Home" subparent="Base" title="Avatars"/>
              ...
              <Row>
                ...
                <Col xl="6 100">
                  <Card>
                    ...
                    <CardBody className="card-body avatar-showcase">
                      <div className="avatars">
                        <div className="avatar ratio"><Media body className="b-r-8 height-100" src={require('../../assets/images/user/1.jpg')} alt="#"/></div>
                        <div className="avatar ratio"><Media body className="b-r-8 height-90" src={require('../../assets/images/user/1.jpg')} alt="#"/></div>
                        <div className="avatar ratio"><Media body className="b-r-8 height-80" src={require('../../assets/images/user/1.jpg')} alt="#"/></div>
                        <div className="avatar ratio"><Media body className="b-r-8 height-70" src={require('../../assets/images/user/1.jpg')} alt="#"/></div>
                        <div className="avatar ratio"><Media body className="b-r-8 height-60" src={require('../../assets/images/user/1.jpg')} alt="#"/></div>
                        <div className="avatar ratio"><Media body className="b-r-8 height-50" src={require('../../assets/images/user/1.jpg')} alt="#"/></div>
                      </div>
                    </CardBody>
                  </Card>
                </Col>
