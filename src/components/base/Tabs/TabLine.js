...
import {MaterialColorTab,MaterialBottomTab,MaterialRightTab,MaterialLeftTab,SimpleMaterialTab,Homes,Profile,Contact,Inbox,Settings,Add} from '../../../constant'
...
const TabLine = (props) => {
  ...
  const [InfoRightLineTab, setInfoRightLineTab] = useState('1');
    ...
    return (
      <Fragment>
        <BreadCrumb parent="Home" subparent="Base / Tabs" title="Line Tabs"/>
                ...
                <Card>
                  ...
                  <CardBody>
                     <Nav className="border-tab" tabs>
                       <NavItem>
                           <NavLink   className={BasicLineTab === '1' ? 'active' : ''} onClick={() => setBasicLineTab('1')}><i className="icofont icofont-ui-home"></i>{Homes}</NavLink>
                       </NavItem>
                       <NavItem>
              ...
              <Col  sm="12" xl="6 xl-100">
                <Card>
                  ...
                  <CardBody>
                     ...
                     <Nav className="border-tab" tabs>
                       <NavItem>
                           <NavLink   className={BottomLineTab === '1' ? 'active' : ''} onClick={() => setBottomLineTab('1')}><i className="icofont icofont-ui-home"></i>{Homes}</NavLink>
                       </NavItem>
                       <NavItem>
                ...
                <Card>
                  ...
                  <CardBody>
                    <Row>
                      ...
                      <NavItem>
                          <NavLink   className={LeftLineTab === '1' ? 'active' : ''} onClick={() => setLeftLineTab('1')}>{Homes}</NavLink>
                      </NavItem>
                      <NavItem >
                ...
                <Card>
                  ...
                  <CardBody>
                    <Row>
                      ...
                      <NavItem>
                          <NavLink   className={RightLineTab === '1' ? 'active' : ''} onClick={() => setRightLineTab('1')}>{Homes}</NavLink>
                      </NavItem>
                      <NavItem >
                ...
                <Card>
                  ...
                  <CardBody>
                     <Nav className="border-tab nav-primary" tabs>
                       <NavItem>
                           <NavLink   className={PrimarycolorLineTab === '1' ? 'active' : ''} onClick={() => setPrimarycolorLineTab('1')}><i className="icofont icofont-ui-home"></i>{Homes}</NavLink>
                       </NavItem>
                       <NavItem>
                ...
                <Card>
                  ...
                  <CardBody>
                     <Nav className="border-tab nav-secondary" tabs>
                       <NavItem>
                           <NavLink   className={SecondarycolorLineTab === '1' ? 'active' : ''} onClick={() => setSecondarycolorLineTab('1')}><i className="icofont icofont-ui-home"></i>{Homes}</NavLink>
                       </NavItem>
                       <NavItem>
                ...
                <Card>
                  ...
                  <CardBody>
                    <Row>
                      ...
                      <NavItem>
                          <NavLink   className={SuccessLeftLineTab === '1' ? 'active' : ''} onClick={() => setSuccessLeftLineTab('1')}>{Homes}</NavLink>
                      </NavItem>
                      <NavItem >
                ...
                <Card>
                  ...
                  <CardBody>
                    <Row>
                      ...
                      <NavItem>
                          <NavLink   className={InfoRightLineTab === '1' ? 'active' : ''} onClick={() => setInfoRightLineTab('1')}>{Homes}</NavLink>
                      </NavItem>
                      <NavItem >
