...
const Breadcrumbs = (props) => {
    return (
        <Fragment>
        <BreadCrumb parent="Home" subparent="Advance" title="Breadcrumb"/>
              ...
              <Col sm="12">
                <Card>
                  ...
                  <ol className="breadcrumb m-b-0 bg-white p-t-0 p-l-0">
                      <BreadcrumbItem  active>{Homes}</BreadcrumbItem>
                  </ol>
                  <ol className="breadcrumb m-b-0 bg-white p-t-0 p-l-0">
                      <BreadcrumbItem tag="a" href="#">{Homes}</BreadcrumbItem>
              ...
              <Col sm="12">
                <Card>
                  ...
                  <ol className="breadcrumb breadcrumb-colored m-b-30 bg-primary">
                      <BreadcrumbItem  href="#">{Homes}</BreadcrumbItem>
                      <BreadcrumbItem active>{Library}</BreadcrumbItem>
                  </ol>
                  ...
                  <ol className="breadcrumb breadcrumb-colored m-b-30 bg-danger">
                   ...
                   <ol className="breadcrumb breadcrumb-colored m-b-30 bg-light">
                      <BreadcrumbItem  href="#" className="txt-dark">{Homes}</BreadcrumbItem>
