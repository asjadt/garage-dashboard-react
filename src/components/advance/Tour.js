...
import { MarekjecnoMailId, MarkJecno, JOHANDIO,Like,Designer,BOD,Email,Follower,Following,ContactUs,Location,Comment,ContactUsNumber,LocationDetails,DDMMYY   } from '../../constant';
const steps = [
    {
        selector: '.step1',
...
const Tours = (props) => {
    ...
    return (
          <Fragment>
          <BreadCrumb parent="Home" subparent="Advance" title="Tour"/>
           <Tour
                    steps={steps}
                    rounded={5}
                    isOpen={opentour}
                  ...
                  <Col sm="12">
                    <Card className="card hovercard text-center">
                      ...
                      <div className="user-image">
                        <div className="avatar"><Media body className="step1" alt="" src={require("../../assets/images/user/7.jpg")} data-intro="This is Profile image" /></div>
                        <div className="icon-wrapper step2" data-intro="Change Profile image here"><i className="icofont icofont-pencil-alt-5"></i></div>
                      </div>
                      <div className="info">
                            ...
                            <Row >
                              <Col md="6">
                                <div className="ttl-info text-left">
                                  <h6><i className="fa fa-envelope"></i>   {Email}</h6><span>{MarekjecnoMailId}</span>
                                </div>
                              </Col>
                              <Col md="6">
