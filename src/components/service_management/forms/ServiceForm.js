          ...
          <Form className="needs-validation" noValidate="" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="form-row mb-2">
              ...
              <Col md="12 mb-3">
                ...
                <Input className="form-control" name="name" type="text" innerRef={register({ required: false })} />
              ...
              <Col md="12 mb-3">
                ...
                <Input className="form-control" name="description" type="textarea" innerRef={register({ required: false })} />
            ...
            {loading && (<div className="loader-box"> <div className="loader-1"></div></div>)}
