...
import { cartProducts, employeeStatus, clients } from './data'
import {Earnings,Messages,NewUser,Products,New,Pending,Done,Cancel,MarkJecno,Manager,Follower,Following,TotalPost,NewOrder,Facebook,Twitter,GooglePlus,Linkedin,Daily,Month,Week,Employee_Status,ContactUs,YourName,Email,Message,SEND_IT,Sale,Today,kolkata_India,India_Surat,RecentActivity,Profit,Loss,Post,ProductsCart,Like,Year} from "../../constant";
const General = () => {
    ...
    return (
      <Fragment>
            <BreadCrumb parent="Home" subparent="Widgets" title="General"/>
              ...
              <CardBody className="bg-primary b-r-4 card-body">
                <div className="media static-top-widget">
                  ...
                  <div className="media-body"><span className="m-0">{Earnings}</span>
                    <h4 className="mb-0 counter">{"6659"}</h4><Database className="icon-bg"/>
                  </div>
                </div>
              </CardBody>
            </Card>
                  ...
                  <div className="bg-secondary b-r-4 card-body">
                    <div className="media static-top-widget">
                      ...
                      <div className="media-body"><span className="m-0">{Products}</span>
                        <h4 className="mb-0 counter">{"9856"}</h4><ShoppingBag className="icon-bg"/>
                      </div>
                    </div>
                  </div>
                </Card>
          ...
          <Col sm="6" xl="3" lg="6">
            <Card className="o-hidden">
                ...
                <div className="media static-top-widget">
                    ...
                    <h4 className="mb-0 counter">{"893"}</h4><MessageCircle className="icon-bg"/>
                    </div>
                </div>
                </CardBody>
            </Card>
            ...
            <Card className="widget-joins widget-arrow">
                ...
                <Col sm="6" className="pr-0">
                    ...
                    <div className="media-body">
                        <h5 className="mb-0">{"$"}<span className="counter">{"25698"}</span></h5><span className="mb-1">{"-$2658(36%)"}</span>
                    </div>
                    </div>
                </Col>
                <Col sm="6" className="pl-0">
                    ...
                    <div className="media-body pl-2">
                        <h5 className="mb-0">{"$"}<span className="counter">{"6954"}</span></h5><span className="mb-1">{"+$369(15%)"}</span>
                    </div>
                    </div>
                </Col>
                <Col sm="6" className="pr-0">
                    ...
                    <div className="media-body align-self-center"><ArrowUp className="font-primary"/></div>
                    <div className="media-body">
                        <h5 className="mb-0">{"$"}<span className="counter">{"63147"}</span></h5><span className="mb-1">{"+$69(65%)"}</span>
                    </div>
                    </div>
                </Col>
                <Col sm="6" className="pl-0">
                    ...
                    <div className="media-body pl-2">
                        <h5 className="mb-0">{"$"}<span className="counter">{"963198"}</span></h5><span className="mb-1">{"+$3654(90%)"}</span>
                    </div>
                    </div>
                </Col>
                </Row>
                     ...
                     <Col sm="6" className="pr-0">
                      <div className="media border-after-xs">
                        ...
                        <div className="media-body details pl-3"><span className="mb-1">{New}</span>
                          <h4 className="mb-0 counter digits">{"6981"}</h4>
                        </div>
                    ...
                    <Col sm="6" className="pl-0">
                      <div className="media">
                        ...
                        <div className="media-body details pl-3"><span className="mb-1">{Pending}</span>
                          <h4 className="mb-0 counter digits">{"783"}</h4>
                        </div>
                    ...
                    <Col sm="6" className="pr-0">
                      <div className="media border-after-xs">
                        ...
                        <div className="media-body details pl-3 pt-0"><span className="mb-1">{Done}</span>
                          <h4 className="mb-0 counter digits">{"3674"}</h4>
                        </div>
                    ...
                    <Col sm="6" className="pl-0">
                      <div className="media">
                        ...
                        <div className="media-body details pl-3 pt-0"><span className="mb-1">{Cancel}</span>
                          <h4 className="mb-0 counter digits">{"069"}</h4>
                        </div>
          ...
          <Col xl="4 box-col-6">
              ...
              <CardBody>
                <Slider {...settings}>
                  {clients.map(data => (
                    ...
                    <p>{data.desc}</p>
                    <img className="img-80" src={data.imagepath} alt="" />
            ...
            <div className="card xl-none">
              <div className="ecommerce-widget card-body">
                <div className="row">
                  <div className="col-6"><span>{NewOrder}</span>
                      ...
                      {employeeStatus.map(data => (
                           ...
                           <td className="bd-t-none u-s-tb">
                             <div className="align-middle image-sm-size">
                               <img className="img-radius align-top m-r-15 rounded-circle" src={data.imagepath} alt="" />
