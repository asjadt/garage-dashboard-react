...
import {lineChart1, lineChart2, lineChart3, barChart, radialChart, radialChartLive, progress1, progress2, progress3, progress4, progress5, columnChart, browserUses, product, turnOver, monthlySale, uses} from './chartsData/charts-data'
import Chart from 'react-apexcharts'
import {ShoppingBag, TrendingUp, Navigation} from 'react-feather'
import {Sparklines,SparklinesLine,SparklinesSpots} from 'react-sparklines'
import {SALE,PRODUCTS,PROJECTS,MarketinExpenses,TotalSales,TotalPurchase,TotalEarning,SkillStatus,OrderStatus,LiveProducts,Turnover,MonthlySales,Uses,BrowserUses,Finance} from '../../constant'
...
const Charts = () =>  {
  ...
  const boxMullerRandom = () => {
    ...
    return (
      <Fragment>
        <BreadCrumb parent="Home" subparent="Widgets" title="Chart"/>
          ...
          <Col xl="4" md="12" className="box-col-12">
            <Card className="o-hidden">
              <div className="chart-widget-top">
                <Row className="card-body">
                    <Col xs="7">
                    <h6 className="f-w-600 font-secondary">{PROJECTS}</h6><span className="num"><span className="counter">{"30"}</span>{"%"}<i className="icon-angle-up f-12 ml-1"></i></span>
                    </Col>
                ...
                <div>
                  ...
                  <Chart options={lineChart2.options} series={lineChart2.series} height="170" type="area" />                  
                  </div>
                </div>
              </div>
            </Card>
             ...
             <Card className="o-hidden">
              <div className="chart-widget-top">
                ...
                <div>
                  ...
                  <Chart options={lineChart3.options} series={lineChart3.series} height="170" type="area" />                  
                  </div>
                </div>
              </div>
            </Card>
        ...
        <Col xl="7" md="12" className="box-col-12">
            <Card className="o-hidden">
                ...
                <CardBody className="bottom-content">
                    ...
                    <Row>
                    <Col xs="12" className="p-b-10">
                        <h6>{TotalSales}</h6>
                        <Row className="progress-showcase">
                        <Col>
                            <div className="progress" style={{'height': '5px'}}>
                            <div className="progress-bar-animated bg-primary progress-bar-striped" role="progressbar" style={{'width': '80%'}} aria-valuenow="10" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                        </Col>
                        </Row>
                    </Col>
                    <Col xs="12" className="p-t-10">
                        <h6>{TotalPurchase}</h6>
                        <Row className="progress-showcase">
                        <Col>
                            <div className="progress" style={{'height': '5px'}}>
                            <div className="progress-bar-animated bg-secondary progress-bar-striped" role="progressbar" style={{'width': '90%'}} aria-valuenow="10" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                        </Col>
                        </Row>
                    </Col>
